...
function createProjectStructure(string $templateDir = null, string $newProjectDir = "")
{
    ...
    $files = [
        ...
        'public/assets/css/input.css' => TemplateLoader::load('public/input.css.stub'),
        'public/assets/css/output.css' => TemplateLoader::load('public/output.css.stub'),
        ...
        'public/assets/js/alpine-cdn.min.js' => TemplateLoader::load('public/alpine-cdn.min.js.stub'),
        'public/assets/js/ythemes-v0.js' => TemplateLoader::load('public/ythemes-v0.js.stub'),
