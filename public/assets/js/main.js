(function(){
    ...
    function appendMessage(message) {
        ...
        var parsedMsg;
        var msgContainer = document.querySelector("#chatform");
    ...
    let socket = new WebSocket("ws://localhost:8920"); //codelab.local:8910
